...
public class GameCenterHasInstalledAdapter extends BaseAdapter {
	...
	public GameCenterHasInstalledAdapter(Context mContext, List<GameInfo> hasInstalledGameData) {
		super();
		this.mContext = mContext;  
        this.mData = hasInstalledGameData; 
