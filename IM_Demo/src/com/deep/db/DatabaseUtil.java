...
import com.deep.db.DBHelper.FavTable;
...
//	    }
	    ...
	    public List<QiangYu> setFav(List<QiangYu> lists) {
	        ...
	        if(lists != null && lists.size() > 0) {
	            for(Iterator<QiangYu> iterator=lists.iterator(); iterator.hasNext();) {
	                ...
	                Log.i(TAG,content.getMyFav()+".."+content.getMyLove());
	            }
	        }
	        if(cursor != null) {
	            cursor.close();
		...
		public ArrayList<QiangYu> queryFav() {
	        ...
	        for(cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
	            ...
	            Log.i(TAG,cursor.getColumnIndex("isfav")+".."+cursor.getColumnIndex("islove")+".."+content.getMyFav()+"..."+content.getMyLove());
